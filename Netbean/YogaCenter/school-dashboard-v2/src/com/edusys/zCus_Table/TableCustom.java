...
import com.edusys.zCus_Scroll.ScrollBarCustomUI;
...
public class TableCustom {
    ...
    public static void apply(JScrollPane scroll, TableType type) {
        ...
        table.setSelectionBackground(new Color(100, 200, 255));
        ...
        table.setGridColor(new Color(250, 255, 255));
        ...
        table.getTableHeader().setBackground(new Color(197,214,254));
